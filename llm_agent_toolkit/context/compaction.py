...
- All actions already attempted and their results (so the next LLM does NOT repeat them)

Be concise, structured, and focused on helping the next LLM seamlessly continue the work."""

SUMMARY_PREFIX = """Another language model started to solve this problem and produced a summary of its thinking process. You also have access to the state of the tools that were used by that language model. Use this to build on the work that has already been done and avoid duplicating work. Do NOT repeat actions that were already tried. Here is the summary:"""
